...
```sh
# Linux / macOS
cc examples/c/gen.c -I bindings/c/include -L target/release -lwickra_synth -lm -o gen
LD_LIBRARY_PATH=target/release ./gen        # macOS: DYLD_LIBRARY_PATH

# Windows (MinGW gcc, linking the DLL directly)
gcc examples/c/gen.c -I bindings/c/include target/release/wickra_synth.dll -lm -o gen.exe
```
